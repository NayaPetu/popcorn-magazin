    ...
    <div className="bg-[#FCFDED] text-[#3E1D08]">
      ...
      <div className="px-6 lg:px-14 py-10 max-w-6xl mx-auto">
        <div className="flex gap-3 mb-5">
          <span className="border border-[#3E1D08] rounded-full px-4 py-1 text-sm font-sans font-light">Физика вокруг</span>
          <span className="border border-[#3E1D08] rounded-full px-4 py-1 text-sm font-sans font-light">8 класс</span>
          <span className="border border-[#3E1D08] rounded-full px-4 py-1 text-sm font-sans font-light">МКТ</span>
        </div>
        <h1 className="font-heading text-[72px] lg:text-[88px] leading-none text-[#F06520] mb-4">
      ...
      <div className="px-6 lg:px-14 pb-16 max-w-6xl mx-auto">
        <div className={`border border-[#D4C4A0] bg-[#F5EDD3] transition-all ${methodOpen ? "rounded-[28px]" : "rounded-full"}`}>
          ...
          {/* Тело */}
          {methodOpen && (
            <div className="px-8 pb-8 text-sm leading-relaxed text-[#3E1D08]">
              <p className="mb-3">
      ...
      <div className="bg-[#FFC044] px-6 lg:px-14 py-12">
        <div className="max-w-6xl mx-auto">
          {/* Пузырь */}
          <svg className="mb-6 h-auto" width="493" height="106" viewBox="0 0 493 106" fill="none" xmlns="http://www.w3.org/2000/svg">

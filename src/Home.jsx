...
export default function Home() {
  ...
  return (
    <div className="bg-white text-[#381a08] font-sans">
      ...
      {/* HERO — текст точно по твоему новому запросу */}
      <section className="bg-[#FFC542] px-8 lg:px-20 py-20 lg:py-28 flex flex-col lg:flex-row justify-between items-center gap-12 w-full">
        <div className="max-w-2xl">
          ...
          {/* Оба строки одного размера (text-3xl), первая — белая, вторая — оранжевая */}
      ...
      {/* КТО МЫ? */}
      <section className="px-8 lg:px-16 py-24 max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-start">
        <div className="relative flex-shrink-0">
          <div className="w-64 h-64 bg-[#FFC542] rounded-[60px] rotate-6 shadow-2xl flex items-center justify-center text-[180px]">🍿</div>
          <div className="absolute -top-8 -right-6 bg-white text-[#381a08] font-bold text-2xl px-8 py-3 rounded-[9999px] shadow-lg">
            КТО МЫ?
          </div>
        </div>

        <div className="max-w-2xl bg-white p-12 rounded-[48px] border border-black/10 flex-1">
          <p className="text-2xl font-bold leading-relaxed">
            Мы научно популярный журнал. Нас завораживает окружающий мир, и мы хотим поделиться своим энтузиазмом через свою работу. Мы хотим показать, что мир работает, потому что существует наука. Наша миссия пробудить любопытство и интерес к миру.
          </p>
        </div>
      </section>
      ...
      <section id="physics-det" className="px-8 lg:px-16 py-24 max-w-7xl mx-auto">
        ...
        <div className="bg-white border-4 border-[#F26522]/10 p-14 rounded-[60px]">
      ...
      <section id="light-det" className="px-8 lg:px-16 py-24 max-w-7xl mx-auto">
        ...
        <div className="bg-white border-4 border-[#FFC542]/10 p-14 rounded-[60px]">
